                    ...
                    <div class="order-item">
                        ...
                        ?>
                                        <div class="order-box">
                                            ...
                                            <div class="danhgia">
                                                <button onclick="toggleCommentForm(<?= $sp_id ?>)">Đánh giá</button>
                                                <form method="GET" action="" id="commentForm<?= $sp_id ?>" style="display:none;">
                                                    <input type="hidden" name="client" value="addComment">
                                                    <input type="hidden" name="iduser" value="<?= $_GET['iduser'] ?>">
                                                    <input type="hidden" name="idsp" value="<?= $sp_id ?>">
                                                    <input type="text" name="comment" placeholder="Nhập đánh giá">
...
<script>
    function toggleCommentForm(productId) {
        var form = document.getElementById("commentForm" + productId);
