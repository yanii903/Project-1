        ...
        ?>
                <div>
                    <div class="cart-word-big">
                        ...
                        <div>Có <?= $gh_quantity   ?> sản phẩn trong giỏ hàng</div>
                    </div>
                    <div class="box-cart">
                                                ...
                                                <div class="box-cart-big-word">
                                                    ...
                                                    <div class="word-left-bottom">
                                                        ...
                                                        <div class="button-quantity">
                                                            <button class="plus" onclick="handelClickMinus()">-</button>
                                                            <!-- <form action=""> -->
                                                            <input class="one" value="<?= $cd_quantity ?>"></input>
                                                            <!-- </form> -->
                                                            <button class="plus" onclick="handelClickAdd()">+</button>
                                                        </div>
                                                        <!-- <script>
