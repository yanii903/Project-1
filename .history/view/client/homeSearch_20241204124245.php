                ...
                <div class="main-full">
                    ...
                    <div class="filter-buttons">
                        <fieldset>
                            ...
                            <button type="button" style="margin: 5px; padding: 10px; border-radius: 5px; width: 99%;" onclick="updateSort('asc')">Tăng dần</button>
                            <button type="button" style="margin: 5px; padding: 10px; border-radius: 5px; width: 99%;" onclick="updateSort('desc')">Giảm dần</button>
                        </fieldset>
                    </div>
