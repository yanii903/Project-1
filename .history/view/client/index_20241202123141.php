    ...
    case 'pay':
        ...
        if (isset($_POST['btnPay'])) {
            ...
            if ($check_valid_order) {
                ...
                //             window.location = '?client=payProfile&iduser=$id_tk';
                //         </script>";
                echo "<script> Swal.fire({ title: 'Chúc mừng!', text: 'Bạn đã mua hàng thành công!', icon: 'success', confirmButtonText: 'OK' }).then((result) => { if (result.isConfirmed) { window.location = '?client=payProfile&iduser=$id_tk'; } }); </script>";
            }
