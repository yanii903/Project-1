...
<head>
    ...
    <link rel="stylesheet" href="view/assets/index.css?v=<?php echo time(); ?>" />
...
<nav>
    <div class="nav-full">
        <?php if (!isset($_SESSION['login'])) { ?>
            ...
            <div class="search">
                <form action=""><button type="submit" style="margin-top: -25px;"><i id="icon-search" class="bx bx-search"></i></button>
                ...
                if ($tk_user == $_SESSION['login']) { ?>
                    ...
                    <div class="category-full">
                        <div class="category">
                            ...
                            <a class="category-link" href="?client=categoryShow&iddm=<?= $dm_id ?>">Danh mục</a>
