...
{
    $sql = "INSERT INTO `order`(`dh_nameUser`, `dh_emailUser`, `dh_phoneUser`, `dh_addressUser`, `dh_countryPay`, `dh_cityPay`, `dh_districtPay`, `dh_communePay`, `dh_messagePay`, `dh_orderdate`, `dh_status`, `dh_totalamount`, `id_tk`, `sp_quantity`) 
