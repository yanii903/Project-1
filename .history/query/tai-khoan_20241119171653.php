...
{
    $sql = "INSERT INTO `account`( `tk_user`, `tk_password`, `tk_email`, `tk_address`, `id_role`) VALUES ( '$tk_user', '$tk_password', '$tk_email', '$tk_address', '$id_role');";
    pdo_execute($sql);
    $tk_id = pdo_last_insert_id(); // Hàm này giả sử trả về ID của bản ghi vừa chèn vào cơ sở dữ liệu

    // Thêm cart cho tài khoản mới
    insert_cart($tk_id);
} //thêm mới tài khoản
