...
Trong trường hợp bạn đã tách riêng phần kết nối cơ sở dữ liệu và sử dụng hàm pdo_execute để thực thi câu lệnh SQL, bạn có thể tạo một phiên bản mở rộng của hàm này, gọi là pdo_execute_return_last_insert_id, để trả về ID của bản ghi vừa được thêm. Dưới đây là cách thực hiện:

1. Tạo hàm pdo_execute_return_last_insert_id
Hàm này sẽ thực thi câu lệnh INSERT và sau đó sử dụng phương thức lastInsertId của PDO để trả về ID của bản ghi vừa được thêm:
