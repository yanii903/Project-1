...
switch ($admin) {
    ...
    case 'productUpdate':
        ...
        if (isset($_POST["submit"])) {
            ...
            if ($sp_pricedel <= $price) {
                $thongBaoGia = 'Vui lòng nhập biến thể giá phải lớn hơn giá!';
            }
    ...
    case 'productColor-Update':
        ...
        if (isset($_POST["submit"])) {
            ...
            if (
                ...
                update_product_color($id, $pc_name, $id_sp);
    ...
    case 'productMemory-Update':
        ...
        if (isset($_POST["submit"])) {
            ...
            if (
                ...
                update_product_memory($id, $pm_name, $id_sp);
                $thongBao = "Sửa thành công";
            }
        }
