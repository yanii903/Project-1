...
<article>
    ...
    <div class="form-container">
        <form action="" enctype="multipart/form-data">
            <div id="search">
                <input style="margin: 0px 0px 5px 6px;" class="form-control" name="inputSearch" type="text" placeholder="Tìm Kiếm Sản Phẩm...">
                <button class="btn btn-primary" style="margin: 1px 0px 0px 6px;" name="btnSearch" type="submit">Tìm Kiếm</button>
            </div>
                    ...
                    <tbody>
                        <?php foreach ($list_product as $product): extract($product) ?>
                            <tr>
                                ...
                                <td><?= $sp_price ?></td>
                                <td class="title"><?= $sp_title ?></td> <!-- Thêm lớp title ở đây -->
                                <td><?= $sp_quantity ?></td>
                                <td><?= $sp_describe ?></td>
                                <td><?= $id_dm ?></td>
                                <td><?= $sp_pricedel ?></td>
