    ...
    <aside>
        <div class="side-bar">
            ...
            <details id="sanPham">
                ...
                <summary>
                    <a href="?act=admin&admin=productList">
                        <i class="fa-brands fa-dropbox"></i> Quản Trị Sản Phẩm
                    </a>
                </summary>
                ...
                <ul>
                    ...
                    <li>
                        <a href="?act=admin&admin=productMemory-Add"><i class="fa-solid fa-plus"></i>Thêm biến thể bộ nhớs</a>
                    </li>
