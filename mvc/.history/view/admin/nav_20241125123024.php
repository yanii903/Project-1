        ...
        <div class="side-bar">
            ...
            <details id="sanPham">
                ...
                <ul>
                    ...
                    <li>
                        <a href="http://localhost/mvc/?act=admin&admin=productColor-Add"><i class="fa-solid fa-memory"></i>Thêm biến thể màu</a>
                    </li>
                    <li>
                        <a href="?act=admin&admin=productMemory-List"><i class="fa-solid fa-memory"></i>Thêm biến thể bộ nhớs</a>
                    </li>
