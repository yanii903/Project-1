...
<body>
    <nav>
        ...
        <ul class="nav-bar">
            <li>
                <a class="nav-item" href="?act=clinet"><i class="fa-solid fa-arrow-left-long"></i> Vào Website</a>
            </li>
            <li>
        ...
        <div class="side-bar">
            <details>
                ...
                <ul>
                    ...
                    <li>
                        <a href="?admin=categoryList"><i class="fa-solid fa-list-ol"></i> Danh Sách Danh Mục</a>
                    </li>
                    <li>
