                ...
                <div class="layout-detail">
                    ...
                    <div class="box-detail">
                        ...
                        <div class="content-two">
                            ...
                            <div class="letter-one-dad">
                                <?php foreach ($list_product_color as $product): extract($product); ?>
                                    <?php if ($id_dm == $dm_id) { ?>
                            ...
                            <?php } else { ?>
                                <div class="letter-product">
                                    ...
                                    <div class="letter-three">
                                        <div><a href="?client=pay&spid=<?= $sp_id ?>">Mua Ngay</a></div>
                                    </div>
                                </div>
                            <?php } ?>
