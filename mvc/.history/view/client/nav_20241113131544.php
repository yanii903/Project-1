            ...
            <?php } else { ?>
                <?php if ($_SESSION['login'] === 'admin') { ?>
                    <a href="?client=login">
                        <div class="login">
                            <i id="icon-login" class="bx bx-user-circle"></i>
                            <a class="login-link" href="?client=login"><?= $_SESSION['login'] ?></a>
                        </div>
                    </a>
                <?php } else { ?>
                    <a href="?client=login">
                        <div class="login">
                            <i id="icon-login" class="bx bx-user-circle"></i>
                            <a class="login-link" href="?client=login"><?= $_SESSION['                            <a class="login-link" href="?client=login"><?= $_SESSION['login'] ?></a>
'] ?></a>
                        </div>
                    </a>
            <?php }
