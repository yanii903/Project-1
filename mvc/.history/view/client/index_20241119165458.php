...
switch ($client) {
    ...
    case 'register':
        ...
        if (isset($_POST['btn-register'], $_POST['name'], $_POST['address'], $_POST['emailRegister'], $_POST['password'], $_POST['confirmPassword'])) {
            ...
            if ($check_valid) {
                // Chèn tài khoản và nhận ID
                $new_account_id = insert_account($name, $password, $emailRegister, $address, $id_role);

                // Chèn bản ghi vào bảng giỏ hàng với idtk là ID của tài khoản vừa tạo
                insert_cart($new_account_id);
