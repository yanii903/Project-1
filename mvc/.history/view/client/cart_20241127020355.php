                    ...
                    <div class="box-cart">
                        ...
                        <div class="box-cart-small">
                            <div class="box-cart-infomation">
                                ...
                                <!-- Nút thanh toán -->
                                <button class="pay">
                                    <a href="?client=pay&spid=<?= implode(',', $productIds) ?>&quantity=<?= implode(',', $quantities) ?>&iduser=<?= $id_tk ?>&totalamount=<?= $totalAmount ?>&totalquantity=<?= $totalQuantity ?>&cartdetailid=<?= $cartdetailIds ?>">THANH TOÁN</a>
                                </button>
