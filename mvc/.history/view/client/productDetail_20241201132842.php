                    ...
                    <div class="box-detail">
                        ...
                        <div class="content-two">
                            ...
                            <div class="letter-one-dad">
                                <a href="">
                                    <?php foreach ($list_product_memory as $product): extract($product); ?>
                                        <?php if ($_GET['id'] == $id_sp) { ?>
                                            <!-- <div style="margin-bottom: 10px;" class="letter-one"><a href=""><?= $pm_name ?></a></div> -->
                                            <input type="radio" id="option<?= $id_pm ?>" name="option" value="<?= $pm_name ?>" />
                                            <label for="option<?= $id_pm ?>"><?= $pm_name ?></label>
                                    <?php }
                                    endforeach ?>
                                </a>
                            </div>
                            ...
                            <div class="letter-one-dad">
                                <a href=""> <?php foreach ($list_product_color as $product): extract($product); ?>
                                        <?php if ($_GET['id'] == $id_sp) { ?>
                                            <div style="margin-bottom: 10px;" class="letter-one"><a href=""><?= $pc_name ?></a></div>
                                    <?php }
                                            endforeach ?>
                                </a>
