                        ...
                        <div class="box-cart-small">
                            <div class="box-cart-infomation">
                                ...
                                <div class="total-amount">
                                    ...
                                    <div class="price-total-amount"><?= $gh_totalamount = printPrice($cd_totalamount)  ?>đ</div>
                                </div>
                                <div class="horizontal-lines"></div>
...
<?php
include "nav.php"; // Gồm menu hoặc điều hướng chính

// Định nghĩa hàm printPrice() để định dạng giá tiền
if (!function_exists('printPrice')) {
...
<div class="layout-cart">
    <?php if (!isset($_SESSION['login'])) { ?>
        <div class="box-fmember">
            <h3>Fmember</h3>
            <div class="image-fmember">
                <img src="https://cdn2.cellphones.com.vn/insecure/rs:fill:0:80/q:90/plain/https://cellphones.com.vn/media/wysiwyg/chibi2.png" height="80" alt="fmember-icon">
            </div>
            <div>Vui lòng đăng nhập tài khoản Fmember để xem ưu đãi và thanh toán dễ dàng hơn</div>
            <div class="button-fmember">
                <div><a href="?client=register"><button class="dangki">Đăng ký</button></a></div>
                    ...
                    <div class="box-cart">
                        ...
                        <div class="box-cart-small">
                            <div class="box-cart-infomation">
                                ...
                                <!-- Nút thanh toán -->
                                <button class="pay">
                                    <a href="?client=pay&spid=<?= implode(',', $productIds) ?>&quantity=<?= implode(',', $quantities) ?>&iduser=<?= $id_tk ?>&totalamount=<?= $totalAmount ?>&totalquantity=<?= $totalQuantity ?>">THANH TOÁN</a>
                                </button>
                                <div class="continue-shopping">
                                    <span><i class="fa-solid fa-arrow-left"></i></span>
                                    <span>Tiếp Tục Mua Hàng</span>
