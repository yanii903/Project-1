                                ...
                                <div class="letter-one-dad">
                                    <?php foreach ($list_product_memory as $index => $product): extract($product); ?>
                                        <?php if ($_GET['id'] == $id_sp): ?>
                                            ...
                                            <input type="radio" id="<?= $radioId ?>" name="option" value="<?= $pm_name ?>" />
                                ...
                                <div class="letter-one-dad">
                                    <?php foreach ($list_product_color as $index => $product): extract($product); ?>
                                        <?php if ($_GET['id'] == $id_sp): ?>
                                            ...
                                            <input type="radio" id="<?= $radioId ?>" name="colorOption" value="<?= $pc_name ?>" />
                                    ...
                                    <div class="letter-product">
                                        ...
                                        <div class="letter-two-dad">
                                            <a href="?client=cartdetail&id=<?= $_GET['id'] ?>&idgh=<?= $idgh ?>">
                                                <div class="letter-two">
                                                    <i id="cart" class="fa-solid fa-cart-shopping"></i>
                                                    <button style="boder: 0px" type="submit">Thêm Giỏ Hàng</button>
                                                </div>
                                            </a>
                                        </div>
                                        <!-- <div class="letter-three-dad">
