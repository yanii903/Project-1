                        ...
                        <div class="content-two">
                            <form action="" method="get">
                                ...
                                <!-- <div class="letter-one-dad">
                                    ...
                                    <?php foreach ($list_product_memory as $index => $product): extract($product); ?>
                                        <?php if ($_GET['id'] == $id_sp):  ?>
                                            <?php $radioId = "option" . $index; ?>
                                            <input type="radio" id="<?= $radioId ?>" name="option" value="<?= $pm_name ?> " checked />
                                ...
                                <div class="letter-one-dad">
                                    ...
                                    <?php
                                    $firstMemory = true;
                                    foreach ($list_product_memory as $product): extract($product);
                                        if ($_GET['id'] == $id_sp):
                                            $radioId = "option" . $product['id'];
                                    ?>
                                            <input type="radio" id="<?= $radioId ?>" name="option" value="<?= $pm_name ?>" <?= $firstMemory ? 'checked' : '' ?> />
                                            <label class="radio" for="<?= $radioId ?>"><?= $pm_name ?></label>
                                    <?php
                                            $firstMemory = false;
                                        endif;
                                ...
                                <div class="letter-one-dad">
                                    <?php
                                    $firstColor = true;
                                    foreach ($list_product_color as $product): extract($product);
                                        if ($_GET['id'] == $id_sp):
                                            $radioId = "colorOption" . $product['id'];
                                    ?>
                                            <input type="radio" id="<?= $radioId ?>" name="colorOption" value="<?= $pc_name ?>" <?= $firstColor ? 'checked' : '' ?> />
                                ...
                                <div style="margin-bottom: 10px;">Màu sắc</div>
                                <div class="letter-one-dad">
                                    <?php foreach ($list_product_color as $index => $product): extract($product); ?>
                                        <?php if ($_GET['id'] == $id_sp): ?>
                                            <?php $radioId = "colorOption" . $index; ?>
                                            <input type="radio" id="<?= $radioId ?>" name="colorOption" value="<?= $pc_name ?> " <?= $index == 0 ? 'checked' : '' ?> />
                                            <label class="radio" for="<?= $radioId ?>"><?= $pc_name ?></label>
                                        <?php endif; ?>
                                    <?php endforeach; ?>
                                </div>
                                ...
                                <?php } else { ?>
                                    <div class="letter-product">
                                        ...
                                        <!-- <div class="letter-three-dad">
                                        <a href="?client=pay&spid=<?= $sp_id ?>&quantity=1&iduser=<?= $id_tk ?>&totalamount=<?= $sp_price; ?>&totalquantity=1">
                                            <div class="letter-three">
                                                <div>Mua Ngay</div>
                                            </div>
                                        </a>
