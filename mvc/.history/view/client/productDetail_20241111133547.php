...
<div class="layout-detail">
    <h2 style="margin-bottom: 10px;">Iphone 15 Pro Max</h2>
    ...
    <div class="box-detail">
        ...
        <div class="content-one">
            ...
            <div class="images-one">
                <div> <img
                        src="./img/iphone-12-pro-max-xanh-duong-new-600x600-600x600-dd0d9c3f-a876-4254-b206-399a8a050fca-228x228.jpg"
                        alt></div>
            ...
            <div class="content-small">
                ...
                <div class="product-small">
                    <div class="betong">
                        <img src="./img/iphone-12-pro-max-xanh-duong-new-600x600-600x600-dd0d9c3f-a876-4254-b206-399a8a050fca-228x228.jpg"
                            alt>
                    </div>
        ...
        <div class="content-two">
            ...
            <div style="margin-bottom: 10px;"><span class="price-sale"
                    style="color: #D70018; padding-right: 10px;">34.990.00đ</span><span><del
                        style="color: gray;">36.990.00đ</del></span></div>
            <div style="margin-bottom: 10px;">Thương hiệu: <span style="font-weight: bold;">Apple</span></div>
    ...
    <div class="evulate-detail">
        <h3>Đánh giá Macbook Air M2 chính hãng Apple Việt Nam</h3>
    ...
    <div class="product-main">
        <div class="product-iphone">
            <div class="betong3">
                <img src="./img/iphone-13_2_.webp" alt="">
            </div>
            <p>Iphone 13 512GB</p>
            <div style="margin-top: 10px;"><del>15.000.000đ</del></div>
            <div style="color: red;margin-top: 5px;">14.500.000đ</div>
            <div class="sale-product">Trả góp 0%</div>
            <div class="promise">BH 12 tháng</div>
            <div class="gear"><i class="fa-solid fa-gear"></i></div>

        </div>
        <div class="product-iphone">
            <div class="betong3"><img src="./img/iphone-14-pro_2__5.png" alt=""></div>
            <p>Iphone 14 Pro Max 512GB</p>
            <div style="margin-top: 10px;"><del>15.000.000đ</del></div>
            <div style="color: red; margin-top: 5px;">14.500.000đ</div>
            <div class="sale-product">Trả góp 0%</div>
            <div class="promise">BH 12 tháng</div>
        ...
        <div class="product-iphone">
            <div class="betong3">
                <img src="./img/600_iphone-15-pro-max-titan-tu-nhien-xtmobile.webp" alt="">
