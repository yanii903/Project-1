    ...
    <div class="order-full">
        <?php foreach ($list_order as $order): extract($order);
            if ($_GET['iduser'] == $id_tk) {
                foreach ($list_orderdetail as $orderdetail) : extract($oorderdetailrder);
                    if ($id_dh == $dh_id) {
                                    ...
                                    <div class="order-item">
                                        <div class="oder-info">
                                            ...
                                            <div class="product-details">
                                                ...
                                                <p class="product-quantity">Số lượng: <?= $order['sp_quantity'] ?></p>
                                                <p class="product-price">Thành tiền: <?= printPrice($order['sp_quantity'] * $sp_price) ?>đ</p>
                                            </div>
                                        </div>
